...
$sql = "INSERT into $table (group_num, depth, ord, id, name, nick, subject,
	content, regist_day, hit, is_html) 
	values($group_num, $depth, $ord, '$userid', '$username', '$usernick', '$subject',
	'$content', '$regist_day', 0, '$is_html')";     
...
$ord = 0; 
	...
	content, regist_day, hit, is_html) 
	values($depth, $ord, '$userid', '$username', '$usernick', '$subject',
	'$content', '$regist_day', 0, '$is_html')";
	mysql_query($sql, $mydb);  // $sql 에 저장된 명령 실행 
...
echo " 
	   <script> 
	    location.href = 'qna_list.php?table=$table&page=$page'; 
	   </script> 
	"; 
?> 