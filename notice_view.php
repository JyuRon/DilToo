...
<?  
	...
	{ 
?> 
	<a href="concert_write_form.php?table=<?=$table?>&mode=modify&num=<?=$num?>&page=<?=$page?>"><img src="./img/modify.png"></a>&nbsp; 
	<a href="javascript:del('concert_delete.php?table=<?=$table?>&num=<?=$num?>')"><img src="./img/delete.png"></a>&nbsp; 
<? 
	} 
?> 
<?  
	...
	{ 
?> 
	<a href="concert_write_form.php?table=<?=$table?>"><img src="./img/write.png"></a> 
<? 
	} 
?> 
	</div> 
