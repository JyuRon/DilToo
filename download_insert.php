...
if ($mode=="modify") 
	...
	$sql = "INSERT into $table (id, name, nick, subject, content, regist_day, hit,  
	 file_name_0, file_name_1, file_name_2, file_type_0, file_type_1, file_type_2, file_copied_0,  file_copied_1, file_copied_2) 
	 values('$userid', '$username', '$usernick', '$subject', '$content', '$regist_day', 0, 
	 '$upfile_name[0]', '$upfile_name[1]',  '$upfile_name[2]', '$upfile_type[0]', '$upfile_type[1]',  '$upfile_type[2]', 
...
echo " 
	   <script> 
	    location.href = 'download_list.php?table=$table&page=$page'; 
	   </script> 
	"; 
?> 
